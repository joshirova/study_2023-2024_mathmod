...
![Создание репозитория](image/2.jpeg){#fig:002 width=70%}

![Добавление файла в репозиторий](image/3.jpeg){#fig:003 width=70%}
...
![Внесение изменений в содержимое репозитория](image/4.jpeg){#fig:004 width=70%}
...
![Просмотр истории](image/7.jpeg){#fig:007 width=70%}
...
![Переключение по имени тега и просмотр доступных тегов](image/10.jpeg){#fig:010 width=70%}
...
![Отмена локальных изменений (до индексации)](image/11.jpeg){#fig:011 width=70%}
...
![Отмена проиндексированных изменений (перед коммитом)](image/12.jpeg){#fig:012 width=70%}
...
![Отмена коммитов](image/13.jpeg){#fig:013 width=70%}
...
![Удаление коммиттов из ветки](image/14.jpeg){#fig:014 width=70%}

![Ничего никогда не теряется](image/15.jpeg){#fig:015 width=70%}
...
![Удаление тега oops](image/16.jpeg){#fig:016 width=70%}
...
![Изменение предыдущего коммита](image/18.jpeg){#fig:018 width=70%}
...
![Каталог .git](image/20.jpeg){#fig:020 width=70%}
...
![Работа непосредственно с объектами git](image/21.jpeg){#fig:021 width=70%}
...
![Редактирование файла](image/24.jpeg){#fig:024 width=70%}

![Редактирование файла](image/25.jpeg){#fig:025 width=70%}
...
![Просмотр логов новой ветки](image/26.jpeg){#fig:026 width=70%}
...
![Создание конфликта](image/31.jpeg){#fig:031 width=70%}
...
![Поиск коммита перед слиянием](image/34.jpeg){#fig:034 width=70%}
...
![Сброс ветки style](image/35.jpeg){#fig:035 width=70%}
...
![Поиск коммита перед конфликтом](image/36.jpeg){#fig:036 width=70%}
...
![Сброс ветки master](image/37.jpeg){#fig:037 width=70%}
...
![Перебазирование](image/38.jpeg){#fig:038 width=70%}

## Слияние в ветку master
 
Вернемся в ветку master и сольем ветку style в неё с помощью команды git merge(рис. @fig:039).

![Слияние style в master](image/39.jpeg){#fig:039 width=70%}
...
![Извлечение изменений](image/44.jpeg){#fig:044 width=70%}
...
![Добавление ветки наблюдения](image/46.jpeg){#fig:046 width=70%}
...
![Отправка изменений](image/48.jpeg){#fig:048 width=70%}


![Извлечение изменений](image/49.jpeg){#fig:049 width=70%}
