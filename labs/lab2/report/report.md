...
![Траекория движения катера в 1 случае](image/1.jpeg){#fig:001 width=70%}
...
![Траекория движения катера и лодки](image/2.jpeg){#fig:002 width=70%}
...
![Траекория движения катера во 2 случае](image/3.jpeg){#fig:003 width=70%}
...
![Траекория движения катера во 2 случае](image/4.jpeg){#fig:004 width=70%}
